    ...
    <div>
        ...
        <div class="space-y-sm" id="info">
            <p>
                ...
                will!
                Deine Teilnahme hilft dabei, wichtige Spenden für lokale Wohltätigkeitsorganisationen zu sammeln,
                die
                sich
                für die Bedürftigen in unserer Gemeinde einsetzen. Egal ob du läufst, gehst oder rollst, jeden
                Meter,
                den du
            ...
            <p>
                ...
                <span class="text-hfm-red">{{ $donationCount }} Spenden-Anmeldungen </span> sind eingegangen. Hilf
                uns,
                noch mehr
                zu erreichen!
            </p>
        ...
        <div class="flex flex-col space-y-sm sm:grid sm:grid-cols-2 max-w-full sm:space-y-0 sm:gap-md mt-lg">
            <x-button icon="information-circle" label="Erfahre mehr" href="/ueber-das-projekt" wire:navigate red
                      xl />
            ...
            <x-button icon="heart" label="Jetzt Spender:in werden" href="/spenderin-werden" wire:navigate
                      red xl />
            <x-button icon="flag" label="Details zum Anlass" href="/informationen-zum-anlass" wire:navigate red
                      xl />
        </div>
    </div>
