    ...
    <form wire:submit="save"
        ...
        <span class="flex flex-row space-x-4">
            <span class="basis-1/3">
                <x-input right-icon="home" label="PLZ" placeholder="8406" wire:model.blur="form.zip_code"
                         class="basis-1/3"/>
            </span>
            <span class="grow">
        ...
        <x-input right-icon="phone" label="Telefon" placeholder="079 123 45 67" wire:model.blur="form.phone_number"/>
        <x-input right-icon="mail" label="E-Mail" placeholder="francesca.arslan@kinderthur.ch"
                 wire:model.blur="form.email"/>
        <x-input right-icon="fire" label="Sportart" placeholder="Joggen" wire:model.blur="form.type_of_sport"/>
