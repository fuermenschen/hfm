<div>
    @component('components.page-title')
        Sportler:in werden
    @endcomponent
Willkommen bei "Höhenmeter für Menschen"! Wir laden dich herzlich ein, Teil dieses besonderen Sponsorenlaufs zu sein, bei dem deine Leidenschaft für Sport mit einem guten Zweck verbunden wird.
