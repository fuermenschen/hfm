...
@section('content')
    <div class="max-w-2xl mx-auto text-left sm:text-center">
        ...
        <x-page-subtitle>
            Link ist abgelaufen oder ungültig
        </x-page-subtitle>

        <p class="mb-6">
            Dieser Login-Link ist nicht mehr gültig. Login-Links sind aus Sicherheitsgründen
            nur kurze Zeit verwendbar.
        </p>

        <p class="mb-6">
            Fordere einen neuen Login-Link an, um dich anzumelden.
        </p>

        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <flux:button href="{{ route('login', ['redirect' => $intendedDestination]) }}" icon="envelope" wire:navigate>
