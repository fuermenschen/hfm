<flux:card>
    <div class="mb-6">
        ...
        <flux:subheading
            >Ergänzt bei SVGs ohne definierte Kontur <code>stroke="none"</code>. Das verhindert schwarze Ränder bei der
            Story-Bild-Erstellung.</flux:subheading>
    </div>

    <flux:button
        wire:click="normalize"
        icon="wrench-screwdriver"
        wire:confirm="Alle SVGs im öffentlichen Speicher normalisieren?"
    >SVGs normalisieren</flux:button>
