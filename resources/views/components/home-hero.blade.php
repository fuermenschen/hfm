<div class="w-full max-w-[600px] h-[calc(100vh-5rem)] min-h-[600px] flex flex-col justify-evenly text-center mx-auto">
    <div class="overflow-clip">
        ...
        <div class="mt-4 sm:mt-8 flex items-center justify-center gap-x-6">
            <a href="#info"
               class="rounded-md bg-hfm-red px-3.5 py-2.5 text-xs sm:text-sm font-semibold text-white shadow-sm hover:bg-hfm-dark dark:hover:bg-hfm-light">Mehr
                dazu</a>
            <a href="{{ route('become-donator') }}" wire:navigate.hover
               class="text-xs sm:text-sm font-semibold leading-6">Spender:in
                werden <span
