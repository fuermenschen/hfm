...
<div class="relative">
    <div class="mx-auto max-w-7xl lg:flex lg:justify-between lg:px-8 xl:justify-end">
        <div
            id="info"
            class="-mx-9 mt-6 sm:mt-8 lg:mt-10 lg:mr-9 lg:flex lg:w-1/2 lg:shrink lg:grow-0 xl:absolute xl:inset-y-0 xl:right-1/2 xl:w-1/2"
        >
            <div class="relative hidden h-80 lg:-ml-48 lg:block lg:h-auto lg:w-full lg:grow">
                <img
            ...
            <div class="relative block h-80 lg:hidden">
                <img
                    class="absolute inset-0 h-full w-full bg-gray-50 object-cover"
                ...
                <div class="mt-10 max-w-xl text-base leading-7 lg:max-w-none">
                    ...
                    <p class="mt-8">
                        <strong class="font-semibold">
                            Sämtliche Spenden gehen zu 100% an die Benefizpartner:innen.
                        </strong>
                        Die ganze Organisation und die damit verbundenen Kosten übernimmt der
