...
<div class="flex flex-wrap items-center gap-2 sm:justify-end">
    ...
    <flux:text wire:loading.delay.short wire:target.except="clearSelection" class="whitespace-nowrap text-xs text-zinc-500">
        Tabelle wird aktualisiert...
    </flux:text>

    <flux:button size="sm" wire:click="clearSelection" wire:target="clearSelection" wire:loading.attr="disabled" :disabled="$selectedCount === 0">
