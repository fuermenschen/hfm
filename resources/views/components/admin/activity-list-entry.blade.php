...
<li>
    <div class="relative pb-8">
        ...
        <div class="relative flex space-x-3">
            <div>
            <span
                class="flex h-8 w-8 items-center justify-center rounded-full bg-hfm-white ring-4 ring-hfm-dark dark:ring-hfm-white dark:bg-hfm-dark">
                {!! $activity_symbol !!}
            </span>
            </div>
