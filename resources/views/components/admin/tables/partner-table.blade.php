<div>
                ...
                <x-slot:bottomLeft>
                    <div class="flex flex-wrap items-center gap-2">
                        <flux:button
                            ...
                            size="sm"
                            icon="plus"
                            wire:click="$dispatchTo('admin-partner-editor', 'open-partner-editor', { partnerId: null })"
                        >Neu</flux:button>
                            ...
                            <flux:table.cell class="w-1 whitespace-nowrap">
                                <div class="flex justify-end gap-1">
                                    <flux:button
                                        ...
                                        square
                                        tooltip="Bearbeiten"
                                        wire:click="$dispatchTo('admin-partner-editor', 'open-partner-editor', { partnerId: {{ $row->id }} })"
                                    />
    ...
    <livewire:admin-partner-editor @partner-saved="$refresh" />
</div>
