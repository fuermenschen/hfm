...
@section('body')
    ...
    <div class="body">
        ...
        <p>Bitte verwende zur Einzahlung den beiliegenden Einzahlungsschein. Die Zahlung des Betrags in Höhe von
            Fr. {{ number_format($totalAmount, 2) }} ist fällig innerhalb 30 Tagen ab Erhalt der Rechnung.</p>
