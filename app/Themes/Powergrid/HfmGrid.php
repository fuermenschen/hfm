...
class HfmGrid extends Tailwind
{
    ...
    public function table(): Table
    {
        return Theme::table('min-w-full')
            ...
            ->div('rounded-t-lg border')
            ->thead('text-hfm-dark bg-white !rounded-t-lg !normal-case !font-medium !tracking-normal shadow-md')
            ->thAction('!font-bold')
            ->tdAction('text-red-500')
            ->tr('bg-slate-200')
            ->trFilters('bg-hfm-white shadow-sm dark:bg-hfm-dark')
            ...
            ->tbody('text-hfm-black dark:text-hfm-white bg-hfm-white dark:bg-hfm-dark')
