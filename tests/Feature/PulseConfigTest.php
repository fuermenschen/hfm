...
it('groups high-cardinality cache keys on the pulse dashboard', function (string $key, string $group): void {
    ...
    'log viewer' => ['lv:3:default:laravel-2026-08-23', 'Log Viewer [lv:*]'],
    ...
    'livewire checksum failure' => ['livewire-checksum-failures:84.226.215.174', 'livewire-checksum-failures:*'],
